...
# 분할 된 Uniprot file마다 확인후 정리
for ai in range(1, 58):

    Uniprot_Info_FileName = str("Uniprot_split_") + str(ai) + str(".txt")
    ...
    print("Read Uniprot data_" + str(ai))
